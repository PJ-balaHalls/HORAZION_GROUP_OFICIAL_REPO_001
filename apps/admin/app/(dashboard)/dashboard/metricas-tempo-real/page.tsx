  ...
  return (
    <div className="p-8 max-w-5xl">
      <div className="flex items-center gap-4 mb-6">
        <h1 className="text-title1 font-bold text-black">metricas-tempo-real</h1>
        <BadgeEmBreve />
      </div>
      <p className="text-highlight text-secondary leading-relaxed mb-10">
        Acesso total ao número de usuários ativos por Grupo Celestial e Domínio. (Requer Sirius Omega).
      </p>
