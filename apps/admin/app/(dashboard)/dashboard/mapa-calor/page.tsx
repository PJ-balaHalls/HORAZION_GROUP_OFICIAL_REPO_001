  ...
  return (
    <div className="p-8 max-w-5xl">
      <div className="flex items-center gap-4 mb-6">
        <h1 className="text-title1 font-bold text-black">mapa-calor</h1>
        <BadgeEmBreve />
      </div>
      <p className="text-highlight text-secondary leading-relaxed mb-10">
        Visualização geográfica de logins, criações de conta e picos de uso. (Requer Sirius Omega + Lince/Esquilo).
      </p>
